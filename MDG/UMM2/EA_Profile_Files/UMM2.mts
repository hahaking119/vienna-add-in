<MDG.Selections model="H:\Repositories\vienna-add-in\MDG\UMM2\UMM2Profile.EAP">
	...
	<Transforms/>
	<ModelTemplates>
		<Model name="Business Requirements View" description="This template creates a new Business Requirements View." location="G:\Enterprise Architect\UMM2\UMM2 Profil\BRVTemplatePackage.xml" default="yes" icon="34" filter="UMM2"/>
		<Model name="Business Choreography View" description="This template creates a new Business Choreography View." location="G:\Enterprise Architect\UMM2\UMM2 Profil\BCVTemplatePackage.xml" default="yes" icon="34" filter="UMM2"/>
		<Model name="Business Information View" description="This template creates a new Business Information View." location="G:\Enterprise Architect\UMM2\UMM2 Profil\BIVTemplatePackage.xml" default="yes" icon="34" filter="UMM2"/>
	</ModelTemplates>
</MDG.Selections>
