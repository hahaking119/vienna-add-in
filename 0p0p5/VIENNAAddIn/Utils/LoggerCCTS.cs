...
namespace VIENNAAddIn.Utils
{
    ...
    internal class LoggerCCTS
    {
        ...
        internal LoggerCCTS(String logDirectory)
            : this()
        {
        ...
        internal int getMessageCount(Priority level)
        {
            ...
            {
                foreach (LogMessageCCTS m in this.logMessages)
                {
        ...
        internal void writeToFile(String filename)
        {
            ...
            foreach (LogMessageCCTS msg in this.logMessages)
            {
                sw.Write("[" + msg.level + "] ");
                sw.Write(msg.dateTime + ": ");
                sw.Write(msg.message + "\n");
