...
namespace VIENNAAddIn.upcc3.repo.BdtLibrary
{
    ...
    {
        public UpccBdtSup(IUmlAttribute umlAttribute, IBdt bdt)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (UpccBdtSup)) return false;
            return Equals((UpccBdtSup) obj);
        }
        ...
        public static bool operator ==(UpccBdtSup left, UpccBdtSup right)
        {
