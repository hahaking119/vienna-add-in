...
namespace VIENNAAddIn.common.corecomponents
{
    public class BIE
    {
        ...
        public string ObjectClassTermQualifier
        {
            get { return objectClassTermQualifier; }
            set { objectClassTermQualifier = value; }
        }
        ...
        {
            get { return propertyTermQualifier; }
            set { propertyTermQualifier = value; }
        }
