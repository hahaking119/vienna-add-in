...
namespace VIENNAAddIn.CCTS
{
    public partial class BIEGenerator : Form, GeneratorCallBackInterface
    {
        ...
        public BIEGenerator(EA.Repository repository, String scope, bool annotate, bool blnIncludeLinkedSchema,
            ...
            ArrayList prmAlreadyCreatedSchemasGlobal, bool prmIsAnyLevelGeneration)
        {
            //Set the debug mode
            //DEBUG = Utility.DEBUG;
        ...
        #region Method for this BIE generator
        /// <summary>
                ...
                if (importPackage.Element.Stereotype.Equals(CCTS_Types.ENUMLibrary.ToString()))
                    ...
                    if (importPackage.Element.Stereotype.Equals(CCTS_Types.QDTLibrary.ToString()))
                        ...
                        if (importPackage.Element.Stereotype.Equals(CCTS_Types.CCLibrary.ToString()))
                            ...
                            if (importPackage.Element.Stereotype.Equals(CCTS_Types.BIELibrary.ToString()))
                                return "bie" + ++countBIEImports; // not sure on this prefix :-?
                        else
