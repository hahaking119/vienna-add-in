...
{
    public class BIEGeneratorXBRL : Form, GeneratorCallBackInterface
    {
        #region Variable
        ...
        private CheckBox chkIncludeLinkedSchema;

        string name = "";
        #endregion

        #region Constructor
        public BIEGeneratorXBRL(EA.Repository repository, String scope)
        {
            InitializeComponent();
        ...
        public BIEGeneratorXBRL(EA.Repository repository, EA.Package package, string path, GeneratorCallBackInterface caller)
        {
            this.caller = caller;
            this.repository = repository;
        ...
        private void InitializeComponent()
        {
            ...
            this.statusTextBox.Location = new System.Drawing.Point(12, 100);
            this.statusTextBox.Name = "statusTextBox";
            this.statusTextBox.Size = new System.Drawing.Size(425, 139);
            ...
            this.Name = "BIEGeneratorXBRL";
            this.Text = "XBRL Generator for BIELibrary";
        ...
        private void getSchemaElement(EA.Element e, XmlSchema schema)
        {
            ...
            if (e.Connectors.Count > 0)
            {
                ...
                if (isRoot)
                {
                    #region generate element ABIE for this root
                    ...
                    #region element for BBIE for this root
