...
namespace VIENNAAddInUnitTests.upcc3.XSDGenerator.Generator.TestRepository
{
    internal class EARepository2 : EARepository
    {
        ...
        public static readonly string ABCCodes = "ABC_Codes";
...
#region ENUMLibrary
        ...
        private static ElementBuilder CDTMeasure()
        {
            return Element("Measure", Stereotype.CDT)
                ...
                Attribute("MeasureUnit.CodeListVersion", Stereotype.SUP, (Path)BLibrary / PRIMLibrary / String).LowerBound("1").UpperBound("*")
                );
        }
