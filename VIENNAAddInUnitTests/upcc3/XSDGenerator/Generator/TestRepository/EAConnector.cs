...
{
    internal abstract class EAConnector : RepositoryElement, Connector
    {
        private readonly Path basedOnType;

        protected EAConnector(Path basedOnType) : base(null)
        {
        ...
        {
            get { return basedOnType.Resolve().ElementID; }
            set { throw new NotImplementedException(); }
        }
